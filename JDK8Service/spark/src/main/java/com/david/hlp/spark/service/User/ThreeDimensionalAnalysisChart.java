...
public class ThreeDimensionalAnalysisChart implements Serializable {
    ...
    public List<JobAnalysisData> getJobAnalysisData(String cityName, String positionName) {
        ...
        // 应用城市和职位的过滤条件
        processedDf = applyFilters(processedDf, cityName, positionName);
     ...
     * 应用城市和职位的过滤条件
     */
    private Dataset<Row> applyFilters(Dataset<Row> processedDf, String cityName, String positionName) {
        // 应用过滤条件

    ...
    <div class="register-box">
      <div class="register-header">
        <div class="logo-container">
          <el-icon class="logo-icon"><svg viewBox="0 0 128 128" width="24" height="24">
              <path
      ...
      <el-form :model="form" :rules="rules" ref="formRef" class="register-form">
        <el-form-item prop="name">
          <el-input v-model="form.name" placeholder="用户名" :prefix-icon="User" :clearable="true" class="custom-input" />
        </el-form-item>

        <el-form-item prop="email">
          <el-input v-model="form.email" placeholder="邮箱" :prefix-icon="Message" :clearable="true" class="custom-input">
            <template #append>
              <el-button type="primary" size="small" @click="handleSendCode"
        ...
        <el-form-item prop="code">
          <el-input v-model="form.code" placeholder="验证码" :clearable="true" class="custom-input" />
        </el-form-item>

      ...
      <div v-if="!loading" class="dashboard-grid">
        ...
        <section class="charts-area" aria-label="数据可视化">
          ...
          <div class="charts-primary">
            <article class="chart-wrapper heatmap-chart">
              ...
              <div ref="heatmapRef" class="chart-container" role="img" aria-label="访问量热力图"></div>
            </article>
            ...
            <article class="chart-wrapper browser-chart">
              ...
              <div ref="browserChartRef" class="chart-container" role="img" aria-label="浏览器分布图"></div>
            </article>
      </div>
          ...
          <div class="charts-secondary">
            <article class="chart-wrapper http-chart">
              ...
              <div ref="httpMethodChartRef" class="chart-container" role="img" aria-label="HTTP方法分布图"></div>
            </article>
            ...
            <article class="chart-wrapper trend-chart">
              ...
              <div ref="weekdayChartRef" class="chart-container" role="img" aria-label="访问趋势图"></div>
            </article>
            </div>
        </section>
        ...
        <section class="data-area" aria-label="详细数据">
          <article class="data-card">
            ...
            <div ref="ipStatsChartRef" class="chart-container geo-chart" role="img" aria-label="地理位置统计图"></div>
          </article>
        </section>
            </div>
    </Transition>

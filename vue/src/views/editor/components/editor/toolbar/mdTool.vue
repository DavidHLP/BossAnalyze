...
<template>
  <div :class="['editor-toolbar', 'markdown-mode', isDark ? 'dark-mode' : 'light-mode']">
    <button @click="markdownModeToolbarCommandHandler(toolBarItem.command, emit)" :key="idx"
      :data-command="toolBarItem.command" v-for="(toolBarItem, idx) in markdownModeToolbarConfig">
